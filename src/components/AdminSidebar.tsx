...
const SECTIONS = [
  ...
  { seg: "settings/sso", label: "SSO" },
  { seg: "settings/permissions", label: "Permissions" },
  { seg: "settings/sla", label: "SLA Policies" },
  { seg: "settings/chat", label: "Chat (Slack/Teams)" },
  { seg: "settings/git", label: "GitHub" },
  { seg: "settings/webhooks", label: "Webhooks" },
  { seg: "settings/automations", label: "Automations" },
  { seg: "settings/security", label: "Security" },
  { seg: "settings/ai", label: "AI settings" },
  { seg: "usage", label: "AI usage" },
