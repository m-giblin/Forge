    ...
    <div className="flex min-h-screen w-full font-[family-name:var(--font-inter)]">
      ...
      >
        <div className="max-w-md px-10 text-center">
          ...
          <h2 className="font-[family-name:var(--font-manrope)] text-2xl font-extrabold leading-tight text-[var(--fw-text-bright)] mb-3">
            Deliver faster without the enterprise overhead.
          </h2>
      ...
      <div className="flex flex-1 items-center justify-center bg-[var(--fw-cream)] px-4 py-10 min-w-0">
        <div className="w-full max-w-sm">
          ...
          {/* OAuth first — the design puts these above the credentials form */}
          ...
          <div className="mb-4 flex items-center gap-3">
            ...
            <span className="text-xs text-[#a19d90]">or continue with email</span>
            <div className="h-px flex-1 bg-[var(--fw-cream-border)]" />
          </div>
          ...
          <p className="mt-5 text-center text-xs text-[#a19d90]">
            By continuing you agree to Forge-Worx&rsquo;s{" "}
            <Link href="/legal/privacy" target="_blank" className="underline hover:text-[#726e60]">Privacy Policy</Link>.
          </p>
        </div>
      </div>
    </div>
