    ...
    return (
      <main className="w-full px-6 py-8">
        <div className="max-w-lg mx-auto mt-24 text-center">
          ...
          <h2 className="text-xl font-bold text-[#20201d] mb-2">Issue Aging Report</h2>
          <p className="text-[#726e60] text-sm mb-6">Surface open issues by age — identify stale work before it becomes a stakeholder risk. Shows age buckets, priority breakdown, and the oldest open items.</p>
