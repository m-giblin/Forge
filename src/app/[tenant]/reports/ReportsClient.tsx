    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-end gap-4">
        ...
        <Link
          ...
          className="ml-2 shrink-0 rounded-lg border border-neutral-200 bg-white px-3 py-1.5 text-xs font-medium text-neutral-600 hover:border-neutral-300 hover:text-neutral-900 transition"
        >
          My contribution →
        </Link>
