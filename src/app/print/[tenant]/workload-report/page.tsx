...
import WorkloadReport from "@/app/[tenant]/admin/workload/report/WorkloadReport";
import type { WorkloadMember } from "@/app/[tenant]/admin/workload/WorkloadClient";

export default async function PrintWorkloadReportPage({ params }: { params: Promise<{ tenant: string }> }) {
  ...
  const activeSprint = primarySprint
    ? { name: primarySprint.name as string, start_date: primarySprint.start_date as string | null, end_date: primarySprint.end_date as string | null }
    : null;
