...
export async function proxy(request: NextRequest) {
  ...
  const ALWAYS_SKIP = ["/api/v1/", "/api/scim/", "/api/auth/", "/api/cron/", "/api/signup", "/api/internal/", "/api/email/inbound", "/api/webhooks/", "/forge-sdk.js", "/rrweb-recorder.min.js", "/login", "/signup", "/preview-landing", "/join", "/shared", "/legal", "/feedback", "/auth/", "/design", "/_next"];
