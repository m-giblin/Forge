...
export type SsoProvider = "google" | "microsoft" | "both";
...
export type SsoConfigPatch = Partial<Pick<SsoConfig, "enabled" | "provider" | "allowed_domain" | "auto_provision" | "sso_required">>;
