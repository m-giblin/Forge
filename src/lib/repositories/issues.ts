...
const COLS =
  "id, tenant_id, project_id, number, title, description, status, priority, type, assignee_id, reporter_id, labels, environment, app_version, stack_trace, source, external_id, category_id, component_id, custom_values, position, start_date, due_date, phase, story_points, time_estimate_minutes, sprint_id, parent_id, triage_suggestion, spec_md, latest_pr_impact, created_at, updated_at";
